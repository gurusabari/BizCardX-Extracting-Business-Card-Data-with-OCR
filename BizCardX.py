...
icon = Image.open("D:\\Program Files\\Visual Studio\\New folder\\icon.png")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By GURU SABARI",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *GURU SABARI*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("D:\\Program Files\\Visual Studio\\New folder\\home.jpg"), width=500)
